...
LDLIBSOPTIONS=-L/usr/local/lib -L/usr/local/ocilib/lib ../../trans/common/dist/Debug/GNU-Linux/libcommon.a ../../base/tools/dist/Debug/GNU-Linux/libtools.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/lib/libjnorderd.${CND_DLIB_EXT}

${HOME}/lib/libjnorderd.${CND_DLIB_EXT}: ../../trans/common/dist/Debug/GNU-Linux/libcommon.a

${HOME}/lib/libjnorderd.${CND_DLIB_EXT}: ../../base/tools/dist/Debug/GNU-Linux/libtools.a

${HOME}/lib/libjnorderd.${CND_DLIB_EXT}: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/lib
	${LINK.c} -o ${HOME}/lib/libjnorderd.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC

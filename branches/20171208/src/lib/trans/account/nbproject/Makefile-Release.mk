...
${OBJECTDIR}/_ext/4f897956/db_riskrule.o: ../../../../../../trunk/src/lib/trans/account/db_riskrule.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4f897956/db_riskrule.o ../../../../../../trunk/src/lib/trans/account/db_riskrule.c

${OBJECTDIR}/_ext/4f897956/riskrule.o: ../../../../../../trunk/src/lib/trans/account/riskrule.c
	${MKDIR} -p ${OBJECTDIR}/_ext/4f897956
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4f897956/riskrule.o ../../../../../../trunk/src/lib/trans/account/riskrule.c

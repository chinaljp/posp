...
int FindAgentByMerhId(Agent *pstAgent, char *pcMerchId) {
    ...
    /* 查找商户所属代理商 */
    snprintf(sSqlStr, sizeof (sSqlStr), "select a.AGENT_ID,a.AGENT_NAME,a.STATUS,a.ZMK, a.AGENT_LEVEL, a.GRADE_AGENT_LEVEL, m.merch_type,a.AGENT_ORGANIZATION "
    ...
    while (OCI_FetchNext(pstRes)) {
        ...
        STRV(pstRes, 8, pstAgent->sAgentOrn);
    }

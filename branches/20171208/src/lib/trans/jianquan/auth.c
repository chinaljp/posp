...
/******************************************************************************/
int JudgeCardTypeName(cJSON *pstTransJson, int *piFlag) {
    CardBin stCardBin;
    char sErr[128] = {0}, sCardType[2] = {0}, sTransCode[6 + 1] = {0};
    char sCardNo[20] = {0}, sName[20] = {0}, sMerchId[16] = {0};
    int iRet = 0;
    ...
    /* 交易鉴权，卡鉴权不做到账人限制*/
    if (!memcmp(sTransCode, "0AA000", 6)) {
        if (FindCardName(sMerchId, sName) != 0) {
...
/******************************************************************************/
int FindcontUplimit(cJSON *pstTransJson, int *piFlag) {
    int iRet = 0;
    char sErr[512] = {0};
    char sMerchId[16] = {0};
    GET_STR_KEY(pstTransJson, "merch_id", sMerchId);
...
/******************************************************************************/
int Findlimit(cJSON *pstTransJson, int *piFlag) {
    int iRet = 0;
    char sErr[512] = {0};
    char sMerchId[16] = {0};
    GET_STR_KEY(pstTransJson, "merch_id", sMerchId);
...
int Insertauthflow(cJSON *pstTransJson, int *piFlag) {
...
int Upwhitelist(cJSON *pstTransJson, int *piFlag) {
    int iNum = 0;
...
/******************************************************************************/
int AddLimitWallet(cJSON *pstTransJson, int *piFlag) {
    int iNum = 0;

...
LDLIBSOPTIONS=-L/usr/local/lib -L/usr/local/ocilib/lib -L/home/post/lib -L../../base/kms -L../../base/tools -L${HOME}/api2016/lib64 -locilib -lzlog -lhiredis -lunionAPI2 ../common/dist/Debug/GNU-Linux/libcommon.a ../../base/kms/dist/Debug/GNU-Linux/libkms.a ../../base/tools/dist/Debug/GNU-Linux/libtools.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/lib/libqrcode.${CND_DLIB_EXT}

${HOME}/lib/libqrcode.${CND_DLIB_EXT}: ../common/dist/Debug/GNU-Linux/libcommon.a

${HOME}/lib/libqrcode.${CND_DLIB_EXT}: ../../base/kms/dist/Debug/GNU-Linux/libkms.a

${HOME}/lib/libqrcode.${CND_DLIB_EXT}: ../../base/tools/dist/Debug/GNU-Linux/libtools.a
...
${OBJECTDIR}/chkoldtransdetail.o: chkoldtransdetail.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/local/include/hiredis -I/usr/local/include -I/usr/local/ocilib/include -I../common -I../../base/tools -I../../base/kms -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chkoldtransdetail.o chkoldtransdetail.c

${OBJECTDIR}/chkterm.o: chkterm.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/local/include/hiredis -I/usr/local/include -I/usr/local/ocilib/include -I../common -I../../base/tools -I../../base/kms -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chkterm.o chkterm.c

${OBJECTDIR}/chkuser.o: chkuser.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/local/include/hiredis -I/usr/local/include -I/usr/local/ocilib/include -I../common -I../../base/tools -I../../base/kms -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chkuser.o chkuser.c

${OBJECTDIR}/db_originfo.o: db_originfo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/local/include/hiredis -I/usr/local/include -I/usr/local/ocilib/include -I../common -I../../base/tools -I../../base/kms -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/db_originfo.o db_originfo.c

${OBJECTDIR}/db_qrcode.o: db_qrcode.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/local/include/hiredis -I/usr/local/include -I/usr/local/ocilib/include -I../common -I../../base/tools -I../../base/kms -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/db_qrcode.o db_qrcode.c
...
${OBJECTDIR}/qrcode.o: qrcode.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/local/include/hiredis -I/usr/local/include -I/usr/local/ocilib/include -I../common -I../../base/tools -I../../base/kms -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/qrcode.o qrcode.c
...
${OBJECTDIR}/wallet.o: wallet.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/local/include/hiredis -I/usr/local/include -I/usr/local/ocilib/include -I../common -I../../base/tools -I../../base/kms -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wallet.o wallet.c

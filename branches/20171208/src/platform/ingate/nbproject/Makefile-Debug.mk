...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/bin/ingate

${HOME}/bin/ingate: ../../lib/base/tools/dist/Debug/GNU-Linux/libtools.a

${HOME}/bin/ingate: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/bin
	${LINK.c} -o ${HOME}/bin/ingate ${OBJECTFILES} ${LDLIBSOPTIONS}

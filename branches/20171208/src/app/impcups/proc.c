...
int ImpAcom(char *pcChannelId, char *pcDate) {
    ...
    while (!feof(pstFp)) {
        ...
        GetField(21, sData, sTmp, g_aiAcom);
        tTrim(sData);
...
int ImpAlfee(char *pcChannelId, char *pcDate) {
    ...
    while (!feof(pstFp)) {
        ...
        GetField(17, stChannnelTransDetail.sOrgSysTrace, sTmp, g_aiAFee);
        tTrim(stChannnelTransDetail.sOrgSysTrace);

        GetField(18, stChannnelTransDetail.sOrgTransmitTime, sTmp, g_aiAFee);
        tTrim(stChannnelTransDetail.sOrgTransmitTime);
        tLog(DEBUG, "SysTrace[%s]TransmitTime[%s]"
                , stChannnelTransDetail.sOrgSysTrace, stChannnelTransDetail.sOrgTransmitTime);
        ...
        UpdChannelFee(pcChannelId, stChannnelTransDetail.sOrgSysTrace, stChannnelTransDetail.sOrgTransmitTime, stChannnelTransDetail.cCardType, stChannnelTransDetail.dChannelFee2, sCurDate);
    }
    tCommit();
    fclose(pstFp);

...
LDLIBSOPTIONS=-L/usr/local/lib -L$HOME/lib -L/usr/local/ocilib/lib -lhiredis -locilib -lzlog ../../lib/base/tools/dist/Debug/GNU-None/libtools.a ../../lib/trans/common/dist/Debug/GNU-Linux/libcommon.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/bin/wzchktrans

${HOME}/bin/wzchktrans: ../../lib/base/tools/dist/Debug/GNU-None/libtools.a

${HOME}/bin/wzchktrans: ../../lib/trans/common/dist/Debug/GNU-Linux/libcommon.a

${HOME}/bin/wzchktrans: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/bin
	${LINK.c} -o ${HOME}/bin/wzchktrans ${OBJECTFILES} ${LDLIBSOPTIONS}

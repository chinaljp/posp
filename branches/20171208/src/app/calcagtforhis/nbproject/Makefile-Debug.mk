...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/bin/calcagtforhis

${HOME}/bin/calcagtforhis: ../../lib/trans/common/dist/Debug/GNU-None/libcommon.a

${HOME}/bin/calcagtforhis: ../../lib/base/tools/dist/Debug/GNU-Linux/libtools.a

${HOME}/bin/calcagtforhis: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/bin
	${LINK.c} -o ${HOME}/bin/calcagtforhis ${OBJECTFILES} ${LDLIBSOPTIONS}

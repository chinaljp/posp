...
LDLIBSOPTIONS=-L/usr/local/ocilib/lib -L/usr/local/lib -L/home/posp/lib -lhiredis -locilib -lm -lzlog -ldl ../../lib/base/tools/dist/Debug/GNU-Linux/libtools.a
...
${OBJECTDIR}/appsvr.o: appsvr.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -I/usr/local/include/hiredis -I/usr/local/include -I../../lib/base/tools -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/appsvr.o appsvr.c

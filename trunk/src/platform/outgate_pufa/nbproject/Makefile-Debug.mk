...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/bin/outgate_pufa

${HOME}/bin/outgate_pufa: ../../lib/base/tools/dist/Debug/GNU-Linux/libtools.a

${HOME}/bin/outgate_pufa: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/bin
	${LINK.c} -o ${HOME}/bin/outgate_pufa ${OBJECTFILES} ${LDLIBSOPTIONS}

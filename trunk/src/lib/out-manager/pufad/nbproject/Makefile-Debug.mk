...
LDLIBSOPTIONS=-L/usr/local/lib -L/usr/local/ocilib/lib -L../../base/kms -L${HOME}/api2016/lib64 -locilib -lhiredis -lzlog -lunionAPI2 ../../base/tools/dist/Debug/GNU-Linux/libtools.a ../../base/hsm/dist/Debug/GNU-Linux/libhsm.a ../../base/kms/dist/Debug/GNU-Linux/libkms.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/lib/libpufad.${CND_DLIB_EXT}

${HOME}/lib/libpufad.${CND_DLIB_EXT}: ../../base/tools/dist/Debug/GNU-Linux/libtools.a

${HOME}/lib/libpufad.${CND_DLIB_EXT}: ../../base/hsm/dist/Debug/GNU-Linux/libhsm.a

${HOME}/lib/libpufad.${CND_DLIB_EXT}: ../../base/kms/dist/Debug/GNU-Linux/libkms.a

${HOME}/lib/libpufad.${CND_DLIB_EXT}: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/lib
	${LINK.c} -o ${HOME}/lib/libpufad.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC

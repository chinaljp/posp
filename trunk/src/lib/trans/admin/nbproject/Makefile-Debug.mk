...
${OBJECTDIR}/sdnotice.o: sdnotice.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -I/usr/local/include/hiredis -I/usr/local/include -I/usr/local/ocilib/include -I../common -I../../base/tools -I../../base/hsm -I../../base/kms -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sdnotice.o sdnotice.c

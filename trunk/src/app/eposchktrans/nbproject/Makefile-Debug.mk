...
LDLIBSOPTIONS=-L/usr/local/lib -L$HOME/lib -L/usr/local/ocilib/lib -lhiredis -locilib -lzlog ../../lib/base/tools/dist/Debug/GNU-None/libtools.a ../../lib/trans/common/dist/Debug/GNU-None/libcommon.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/bin/eposchktrans

${HOME}/bin/eposchktrans: ../../lib/base/tools/dist/Debug/GNU-None/libtools.a

${HOME}/bin/eposchktrans: ../../lib/trans/common/dist/Debug/GNU-None/libcommon.a

${HOME}/bin/eposchktrans: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/bin
	${LINK.c} -o ${HOME}/bin/eposchktrans ${OBJECTFILES} ${LDLIBSOPTIONS}

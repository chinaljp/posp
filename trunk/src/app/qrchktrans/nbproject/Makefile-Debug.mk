...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/bin/qrchktrans

${HOME}/bin/qrchktrans: ../../lib/base/tools/dist/Debug/GNU-None/libtools.a

${HOME}/bin/qrchktrans: ../../lib/trans/common/dist/Debug/GNU-None/libcommon.a

${HOME}/bin/qrchktrans: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/bin
	${LINK.c} -o ${HOME}/bin/qrchktrans ${OBJECTFILES} ${LDLIBSOPTIONS}

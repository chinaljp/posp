...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/bin/zximpcups

${HOME}/bin/zximpcups: ../../lib/base/tools/dist/Debug/GNU-Linux/libtools.a

${HOME}/bin/zximpcups: ../../lib/trans/common/dist/Debug/GNU-Linux/libcommon.a

${HOME}/bin/zximpcups: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/bin
	${LINK.c} -o ${HOME}/bin/zximpcups ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/db_import.o: db_import.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/local/include/hiredis -I/usr/local/include -I/usr/local/ocilib/include -I../../lib/base/tools -I../../lib/trans/common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/db_import.o db_import.c

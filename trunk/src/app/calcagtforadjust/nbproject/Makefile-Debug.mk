...
LDLIBSOPTIONS=-L/usr/local/lib -L/home/posp/lib -L/usr/local/ocilib/lib -L../../lib/trans/common -L../../lib/base/tools -locilib -lzlog -lhiredis ../../lib/trans/common/dist/Debug/GNU-Linux/libcommon.a ../../lib/base/tools/dist/Debug/GNU-None/libtools.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${HOME}/bin/calcagtforadjust

${HOME}/bin/calcagtforadjust: ../../lib/trans/common/dist/Debug/GNU-Linux/libcommon.a

${HOME}/bin/calcagtforadjust: ../../lib/base/tools/dist/Debug/GNU-None/libtools.a

${HOME}/bin/calcagtforadjust: ${OBJECTFILES}
	${MKDIR} -p ${HOME}/bin
	${LINK.c} -o ${HOME}/bin/calcagtforadjust ${OBJECTFILES} ${LDLIBSOPTIONS}
